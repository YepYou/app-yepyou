  ...
  return (
    <>
      ...
      <Layout style={styles.container}>
            ...
            <View style={styles.missionDetailsRowContent}>
              ...
              <View style={styles.iconsWrapper}>
                {[...Array(5)].map((x, i) => {
                  return (
                    <Image
                      style={styles.avatarPoints}
                      key={i}
                      source={mission.parentInvolvement > i ? manOn : manOff}
                    />
                  );
                })}
              </View>
            ...
            <View style={styles.missionDetailsRowContent}>
              ...
              <View style={styles.estimatedTimeWrapper}>
                ...
                <Text style={styles.estimatedTimeText}>
                  {moment.duration(mission.estimatedTime, 'minutes').hours() >
                    0 &&
                    ` ${moment
                      .duration(mission.estimatedTime, 'minutes')
                      .hours()}h`}
                  {moment.duration(mission.estimatedTime, 'minutes').minutes()}
                  min
                </Text>
              </View>
            </View>
                ...
                {[...Array(5)].map((x, i) => {
                  return (
                    <Image
                      style={styles.avatarPoints}
                      key={i}
                      source={mission.materialUse > i ? boxOn : boxOff}
                    />
                  );
                })}
              </View>
                ...
                {[...Array(5)].map((x, i) => {
                  return (
                    <Image
                      style={styles.avatarPoints}
                      key={i}
                      source={mission.difficulty > i ? checkOn : checkOff}
                    />
                  );
                })}
              </View>
        ...
        <TouchableOpacity style={styles.button} onPress={acceptMission}>
